...
I will leave the data set like this for now since I have not decided yet about what aspect would I focus on form this data set. I might explore the recall reason, or the distribution of brand/company, or summarize the recall by date or month...
